...
אם הכתבה מזכירה דיון עתידי עם תאריך:
{
  ...
  "event": "שם קצר לאירוע יומן — לא כותרת הכתבה. בסגנון: 'דיון במשפטו של X', 'ישיבת בג\"ץ בעניין Y', 'הכרעת דין בפרשת Z'. עד 60 תווים.",
  "description": "משפט אחד: היכן יתקיים הדיון ומה נושאו. לא לחזור על כותרת הכתבה. עד 150 תווים."
}
...
- שדה event הוא שם אירוע יומן בלבד — לא כותרת עיתונאית"""
